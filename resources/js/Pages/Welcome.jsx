                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:justify-center lg:col-start-2">
                                <ApplicationLogo className="h-10 w-auto text-black dark:text-white" />
                            </div>
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                        ...
                                        >
                                            ...
                                            <div className="pt-3 sm:pt-5 lg:pt-0">
                                                ...
                                                <p className="mt-4 text-sm/relaxed">
                                                    Playlistrix is a playlist
                                                    manager that allows you to
                                                    create, edit, and delete
                                                    your playlists in Spotify.
                                                    It has additional features
                                                    like sharing your playlists
                                                    with others and searching
                                                    for songs to add to your
                                                    playlists. On top of that
                                                    you can start to make
                                                    playlists based on your own
                                                    liked songs or your top
                                                    tracks, split up into genres
                                                    or styles that you can
                                                    choose from!
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <a className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                    <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <svg
                                            className="size-5 sm:size-6"
                                            xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Playlistrix is an open-source
                                            project that is free to use. If you
                                            like the project and want to support
                                            it, you can do so by contributing to
                                            the project on GitHub, or support us
                                            on Patreon. You can also help by
                                            reporting bugs or suggesting new
                                            features.
                                        </p>
                                    </div>
                                ...
                                <a
                                    target="_blank"
                                    href="https://github.com/JSonAR2/spotify-app"
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Playlistrix is intended to be a
                                            project to keep developing. For more
                                            features relating to Spotify and
                                            branching out into other music
                                            platforms, check out the project on
                                            GitHub.
                                        </p>
                                    </div>
                                ...
                                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        <h2 className="text-xl font-semibold text-black dark:text-white">
                                            Find out what other users are
                                            listening to
                                        </h2>

                                        <p className="mt-4 text-sm/relaxed">
                                            On top of all the data provided to
                                            us by Spotify, we also analyse the
                                            data of what our users are creating
                                            and listening to. Find out what is
                                            trending here
                                        </p>
                                    </div>
                                </div>
